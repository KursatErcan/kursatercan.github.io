...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Kürşat Ercan| Personal Website";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["junior software developer", "junior android developer", "always a student"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
srtop.reveal('.home .googleDeveloper',{interval: 1000});
